...
& "backend/.venv/Scripts/python.exe" -m PyInstaller --clean --noconfirm --onefile --name backend --distpath backend/dist/windows --workpath backend/build/windows --specpath backend/build/windows --paths backend backend/app/main.py
